...
gsap.registerPlugin(ScrollTrigger, useGSAP);
  ...
  useEffect(() => {
    ...
    const curvePath = "M 50 200 Q 800 50 1150 200";
    const curvePath2 = "M 50 200 Q 500 50 1150 200";
  ...
  return (
    ...
    >
      ...
      <canvas
        ref={canvasRef}
        className={`absolute inset-0 z-0 w-full h-fit object-cover  brightness-[0.9] scale-[1.1] saturate-150 transition-opacity duration-1000 ${isLoading ? 'opacity-0' : 'opacity-100'}`}
      />
             ...
             <svg viewBox="0 0 1200 300" className="w-full h-fit overflow-visible">
               ...
               >
                 <textPath href="#curve2" startOffset="50%">
                    <tspan className='dancing'>Sunshine❤️</tspan>
